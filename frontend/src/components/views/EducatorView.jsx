...
export function EducatorView({
  ...
  const renderSection = (sec) => {
    ...
    if (!sec.locked) {
      ...
      const displayTitle = sec.title || 'Specialized Facilitation Guide';
      ...
      const secContent = (rawContent && typeof rawContent === 'string' && !rawContent.includes('is not generated yet'))
        ...
        : (typeof rawContent === 'object' && rawContent !== null
            ? rawContent
            : (sec.instruction ? `### 1. Facilitation Overview & Objectives\n${sec.instruction}\n\n*Detailed educator facilitation notes, classroom rubrics, and discussion guides are actively being generated for this section.*` : '### 1. Facilitation Overview\nFacilitator guidance is being prepared for this section.'));
