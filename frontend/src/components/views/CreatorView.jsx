  ...
  return (
    <>
      {listToRender.map((sec) => {
        ...
        const displayTitle = sec.title || 'Specialized Section';
        ...
        const secContent = (rawContent && typeof rawContent === 'string' && !rawContent.includes('is not generated yet'))
          ...
          : (typeof rawContent === 'object' && rawContent !== null
              ? rawContent
              : (sec.instruction ? `### 1. Overview & Objectives\n${sec.instruction}\n\n*Detailed step-by-step procedures and practical exercises are actively being generated for this section.*` : '### 1. Overview\nComprehensive instructional content is being prepared for this section.'));
